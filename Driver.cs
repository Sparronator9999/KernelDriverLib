using KernelDriverLib.Win32;
using System;
using System.IO;
using System.Runtime.InteropServices;
using System.Security.AccessControl;

namespace KernelDriverLib
{
    /// <summary>
    ...
    public class Driver : IDisposable
    {
        ...
        /// will also be used as the service ID.
        /// </para>
        /// </param>
        ...
        /// </summary>
        /// <param name="secure">
        /// <para>If <c>true</c>, the device created by the driver will
        /// only be accessible by users with administrator access.</para>
        /// <para>Recommended for drivers such as WinRing0.</para>
        /// </param>
        /// <returns>
        /// <c>true</c> if the driver was installed
        /// successfully, otherwise <c>false</c>.
        /// </returns>
        public bool Install(bool secure = true)
        {
            ErrorCode = 0;
        ...
        {
            // Don't do anything if the driver's device is not open:
            if (!IsOpen)
            {
                return;
            }
